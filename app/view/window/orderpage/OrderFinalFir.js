...
import OrderFinalDetail from './OrderFinalDetail';
import OrderFinalFirNews from './OrderFinalFirNews'
// var comdtime=600;
var navigation=null
...
export default class OrderFinalFir extends Component {
    ...
    render(){
        ...
        return(<View style={{flex:1,flexDirection:'column',zIndex:100,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                <OrderFinalDetail navigation={navigation}/>
                <OrderFinalFirNews navigation={navigation}/>
