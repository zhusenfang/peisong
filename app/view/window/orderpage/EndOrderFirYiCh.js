...
import EndOrderFirstYiDetail from './EndOrderFirstYiDetail';
import EndOrderFirYiNews from './EndOrderFirYiNews'
// var comdtime=600;
var navigation=null
...
export default class EndOrderFirYiCh extends Component {
    ...
    render(){
        ...
        return(<View style={{flex:1,flexDirection:'column',zIndex:100,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                <EndOrderFirstYiDetail navigation={navigation}/>
                <EndOrderFirYiNews navigation={navigation}/>
