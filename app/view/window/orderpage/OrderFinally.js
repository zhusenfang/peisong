...
import OrderFinalFirst from './OrderFinalFirst';
import OrderFinalSecond from './OrderFinalSecond'
import {Container, Tab, Tabs,TabHeading} from 'native-base';
import CommonModal from '../../CommonPage/ComonModal'
var navigation=null
export default class OrderFinally extends Component{
    constructor(props){
        super(props);
        this.state={
            msg:'',
    ...
    componentWillMount(){
        postFetch(API.Order,{expressageOrder:{type:0,phase:4},pageNum:1,numPerPage:10},(result)=>{
            this.setState({
        ...
        postFetch(API.Order,{expressageOrder:{type:1,phase:4},pageNum:1,numPerPage:10},(result)=>{
            this.setState({
    ...
    render(){
        return(<View style={{flex:1,marginTop:20,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                >
                    <OrderFinalFirst navigation={navigation}/>
                ...
                >
                    <OrderFinalSecond navigation={navigation}/>
