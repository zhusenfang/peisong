...
import ProgressDaoDetails from './ProgressDaoDetails';
import ProgressDaoNews from './ProgressDaoNews'
// var comdtime=600;
var navigation=null
...
export default class ProgressDaoOrder extends Component {
    ...
    render(){
        ...
        return(<View style={{flex:1,flexDirection:'column',zIndex:100,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                <ProgressDaoDetails navigation={navigation}/>
                <ProgressDaoNews navigation={navigation}/>
