...
import EndOrderDetail from './EndOrderDetail';
import EndOrderFirstNews from './EndOrderFirstNews'
// var comdtime=600;
var navigation=null
...
export default class EndOrderFir extends Component {
    ...
    render(){
        ...
        return(<View style={{flex:1,flexDirection:'column',zIndex:100,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                <EndOrderDetail navigation={navigation}/>
                <EndOrderFirstNews navigation={navigation}/>
