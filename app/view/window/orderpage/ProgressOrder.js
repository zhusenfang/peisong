...
export default class ProgressOrder extends Component {
    ...
    componentWillMount(){
        postFetch(API.Order,{expressageOrder:{type:0,phase:1},pageNum:1,numPerPage:10},(result)=>{
            this.setState({
        ...
        postFetch(API.Order,{expressageOrder:{type:1,phase:1},pageNum:1,numPerPage:10},(result)=>{
            this.setState({
