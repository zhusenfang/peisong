...
export default class OrderSecondDetail extends Component {
    constructor(props){
        super(props)
        this.state={
            time:0,//订单时间
        ...
        return(
            <View style={{flex:1,backgroundColor:'#f9f9f9'}}>
                <ScrollView style={{width:Contants.Screen.width}} >
                    ...
                    <View style={{width:Contants.Screen.width,height:1,backgroundColor:'#E5E5E5',marginBottom:40}}>
    ...
    shouli(){
        ...
        //     return
        // }
        postFetch(API.WaisongJieDan,{expressageOrder:{
            id:list,
