...
import EndDaoYiDetail from './EndDaoYiDetail';
import EndDaoYiNews from './EndDaoYiNews'
// var comdtime=600;
var navigation=null
...
export default class EndOrderYiChang extends Component {
    ...
    render(){
        ...
        return(<View style={{flex:1,flexDirection:'row',zIndex:100,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                <EndDaoYiDetail navigation={navigation}/>
                <EndDaoYiNews navigation={navigation}/>
