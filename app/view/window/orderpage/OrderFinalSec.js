...
import OrderFinalSecDetail from './OrderFinalSecDetail';
import OrderFinalSecNews from './OrderFinalSecNews'
// var comdtime=600;
var navigation=null
...
export default class OrderFinalSec extends Component {
    ...
    render(){
        ...
        return(<View style={{flex:1,flexDirection:'column',zIndex:100,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                <OrderFinalSecDetail navigation={navigation}/>
                <OrderFinalSecNews navigation={navigation}/>
