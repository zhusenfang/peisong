...
var navigation=null
export default class OrderFinalFirst extends Component {
    mixins:[TimerMixin]
    constructor(props){
        super(props);
    ...
    fetchdata(page){
        postFetch(API.Orderhistory,{expressageOrder:{type:0,phase:4},pageNum:page,numPerPage:10},(result)=>{
    ...
    select(rowData){
        ...
        this.props.navigation.navigate('OrderFinalFir',{data:JSON.stringify(rowData.deliveryOrderId)})
