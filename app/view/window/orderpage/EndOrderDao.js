...
import EndOrderDaoDetail from './EndOrderDaoDetail';
import EndOrderDaoNews from './EndOrderDaoNews'
// var comdtime=600;
var navigation=null
...
export default class EndOrderDao extends Component {
    ...
    render(){
        ...
        return(<View style={{flex:1,flexDirection:'column',zIndex:100,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                <EndOrderDaoDetail navigation={navigation}/>
                <EndOrderDaoNews navigation={navigation}/>
