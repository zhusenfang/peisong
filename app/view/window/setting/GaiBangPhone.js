...
export default class GaiBangPhone extends Component {
    constructor(props){
        super(props)
        this.state={
            content:''
    ...
    render(){
        return(<View style={styles.contain}>
            ...
            <Text style={styles.phone}>输入新的手机号码</Text>
    ...
    sendCaptcha=()=>{
        ...
        postFetch(API.ForgetPwd,{phone:phoneNum},(result)=>{
            ...
            if(result.status==0){
                ...
                if(result.status==1){
                    this._toast.show(result.msg)
                    this.props.navigation.navigate('GaiBangYanZheng',{data:this.state.content})
                }
                //
            }
        },(error)=>{
