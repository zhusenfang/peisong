    ...
    render(){
        ...
        return(
            ...
            <View style={[comstyle.item,{marginTop:10}]}>
                ...
                {/*<Text onPress={()=>{this.props.navigation.navigate('ClassifyAdd',{data:list,callback:(data)=>{}})}}>{'>'}</Text>*/}
                <TouchableOpacity onPress={()=>{this.props.navigation.navigate('ClassifyAdd',{data:list,callback:(data)=>{}})}} style={styles.img}>
