...
import GGInput from './CommonPage/ZhuPhoneInput';
    ...
    render(){
        return(
            ...
            <View style={[styles.contain,{backgroundColor:'#fff'}]}>
                ...
                <Image source={require('../img/login/pwdtwo.png')} style={{width:Contants.Screen.width,height:70,}}/>
                ...
                <TouchableOpacity onPress={()=>{ this.props.navigation.navigate('ForgetViewThree')}
