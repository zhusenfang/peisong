            ...
            <View style={{flexDirection:'column'}}>
                <View style={this.props.style}>
                    ...
                    <View style={InputStyle.leftTextView}>
                        <Image source={this.props.isPwd?require('../img/login/pwd.png'):require('../img/login/phone.png')}
                               style={{marginRight:15,marginLeft:10}}/>
                        {/*<Image source={require('../img/login/phone.png')} style={{marginTop:20,marginRight:15}}/>*/}
